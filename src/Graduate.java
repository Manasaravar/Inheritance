public class Graduate extends Student{
    ...
    public Graduate(Human human, String speciality, String group, double rating, double attendance, String subject) {
        super(human, speciality, group, rating, attendance);
        setSubject(subject);
